...
export class AppHighLightDirective {
  @Input('appAppHighLight') myColor!: string;
  ...
  @HostBinding('style.border-color') inputbordercolor!: string;
  @HostListener('keydown') onKeyDown() {
    const indexcolor = Math.floor(Math.random() * this.colorArray.length);
    this.inputcolor = this.inputbordercolor = this.colorArray[indexcolor];
  }
